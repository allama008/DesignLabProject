...
$bid= $_GET["bid"];
$desg= $_GET["desg"];
$url_yes= 'http://127.0.0.1:8081/designlab/index1.php?bid='.$bid.'&desg='.$desg.'&yes=true&no=false';
$url_no= 'http://127.0.0.1:8081/designlab/index1.php?bid='.$bid.'&desg='.$desg.'&yes=false&no=true';
?>
